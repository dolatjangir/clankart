...
<!-- header-section -->
  ...
  <div class="header xl:h-[110px] sm:h-[60px] fixed z-20 bg-white w-screen  px-4 flex ">
    ...
    <!-- section-1 -->
    <section class="pb-5 pt-[120px] bg-white flex justify-center items-center">
    <div class="container px-md-0 ">
      <img src="https://www.clankart.com/static-assets/about-us.jpg" class="max-w-full max-h-[350px]" alt="About Us">
    </div>
  </section>
  <!-- aection-2 -->
  <section class="py-12 bg-white pitch-deck flex justify-center items-center">
    <div class="container">
      <div class="text-center flex flex-col items-center">
        <h1 class="text-4xl  font-serif">India's no. 1 platform to buy, sell used books for cash.</h1>
        <h2 class="pt-5 text-2xl  text-neutral-600 w-fit  border-b  border-blue-400">Our story begins with you</h2>
      </div>

      <div class="py-5">
        <h3 class="text-left text-xl  pb-2 font-semibold">A Student-to-Student Bookstore!</h3>
        <p class="pt-0 text-lg text-neutral-700 font-semibold leading-relaxed">
          Clankart (owned by 'Boolean Infotech Solutions') is all about you. Clankart is an intercommunity online 'student-to-student' bookstore that connects students to buy or sell used books by making it fast and easy for anyone to post a listing on the web. Sellers can easily earn some extra cash by simply posting used books that are no longer in use for them - thus, giving buyers the opportunity to find great value books at affordable price deals. Clankart is committed to creating a sustainable and eco-friendly approach to book exchanges. By giving used books a second life, we're reducing waste and promoting a more environmentally conscious student community.
        </p>
        <p class="fancy-font italic mt-4">
          <mark>
            <em>
              "<a href='/post-ad' title='Sell your used books for cash' class="text-blue-600 underline">Selling used second-hand books</a> at your own desired price is not an uphill battle anymore. Just sell them on Clankart!"
            </em>
          </mark>
        </p>
        <p class="mt-4 text-neutral-700 font-semibold ">
          Join the Clankart community and be part of a movement that's not only about affordable books but also about making a positive impact on the planet. 
          <i class="bi bi-globe-americas text-green-600"></i>
        </p>
      </div>

      <div class="mt-6">
        <a href="/how-it-works" title="See how does it work for sellers and buyers" class="text-2xl text-blue-600 underline">See how does it work?</a>
      </div>

      <div class="pt-5 flex flex-wrap justify-center">
        <iframe class="max-w-lg w-full px-2" height="315" src="https://www.youtube.com/embed/yEVy3WBGmh0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

        <iframe class="max-w-lg w-full px-2 mt-4 sm:mt-0" height="315" src="https://www.youtube.com/embed/Rwj6vi55hHw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  </section>
<!-- section-3 -->
<div class="w-full bg-white overflow-hidden box-border marquee-container">
  ...
  <section class="py-12 bg-white">
    <div class="container mx-auto">
      <div class="border-l-4 border-blue-500 bg-blue-50">
        <div class="flex flex-col md:flex-row items-center justify-around py-10 px-5 ">
          <div class="flex items-center">
            ...
            <div>
              <span class="text-lg text-gray-700 font-light">
                If you've got any suggestions or questions, don't hesitate to drop us a note at 
                <a href="mailto:support@clankart.com" class="text-blue-500 font-semibold">support@clankart.com</a>
              </span>
            </div>
          </div>
        </div>
  ...
  <section class="py-12 bg-white">
    <div class="container mx-auto">
      <p class="text-center text-4xl font-bold">Follow us on Social Media</p>
      
      <ul class="flex flex-wrap justify-center mt-10">
        <li v-for="social in socials" :key="social.name" class="w-full sm:w-1/4 text-center font-bold py-5">
          <div class="flex items-center justify-center">
            <a :href="social.link" target="_blank" rel="noopener noreferrer" class="flex items-center">
              <img :src="social.icon" class="w-12 h-12 bg-transparent" :alt="`Clankart on ${social.name}`" />
              <div class="ml-2 text-lg text-left text-blue-500">
                {{ social.name }}
                <span class="block text-gray-500 font-semibold">{{ social.handle }}</span>
              </div>
            </a>
          </div>
        </li>
  ...
  <section class="py-12 bg-gray-100">
    <div class="container mx-auto">
      <p class="text-center text-4xl font-semibold">Clankart Featured On</p>
      
      <ul class="flex flex-wrap justify-center mt-8">
        <li v-for="feature in features" :key="feature" class="w-full sm:w-1/4 text-center text-neutral-500 font-semibold py-5">
...
const socials = ref([
{ name: "Facebook", link: "https://www.facebook.com/clankart", icon: "https://www.clankart.com/static-assets/facebook.png", handle: "@clankart" },
        { name: "Instagram", link: "https://www.instagram.com/clankart", icon: "https://www.clankart.com/static-assets/instagram.png", handle: "@clankart" },
        { name: "YouTube", link: "https://www.youtube.com/@clankart", icon: "https://www.clankart.com/static-assets/youtube.png", handle: "@clankart" },
        { name: "Twitter", link: "https://twitter.com/clankartTeam", icon: "https://www.clankart.com/static-assets/twitter.png", handle: "@clankartTeam" },
]);
